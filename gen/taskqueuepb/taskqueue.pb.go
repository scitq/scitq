...
var file_taskqueue_proto_rawDesc = string([]byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xf8,
	0x02, 0x0a, 0x09, 0x54, 0x61, 0x73, 0x6b, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x3d, 0x0a, 0x0a,
	...
	0x54, 0x61, 0x73, 0x6b, 0x4c, 0x6f, 0x67, 0x30, 0x01, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e,
...
var file_taskqueue_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_taskqueue_proto_depIdxs = []int32{
	...
	1, // 7: taskqueue.TaskQueue.SubmitTask:output_type -> taskqueue.TaskResponse
	8, // 8: taskqueue.TaskQueue.RegisterWorker:output_type -> taskqueue.Ack
	4, // 9: taskqueue.TaskQueue.PingAndTakeNewTasks:output_type -> taskqueue.TaskList
	8, // 10: taskqueue.TaskQueue.UpdateTaskStatus:output_type -> taskqueue.Ack
	8, // 11: taskqueue.TaskQueue.SendTaskLogs:output_type -> taskqueue.Ack
	6, // 12: taskqueue.TaskQueue.StreamTaskLogs:output_type -> taskqueue.TaskLog
