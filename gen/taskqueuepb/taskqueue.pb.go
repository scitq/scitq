...
const file_taskqueue_proto_rawDesc = "" +
	...
	"\x05files\x18\x01 \x03(\tR\x05files2\xb6\x13\n" +
	"\tTaskQueue\x12=\n" +
	"\n" +
...
var file_taskqueue_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_taskqueue_proto_goTypes = []any{
	...
	nil,                               // 70: taskqueue.TaskUpdateList.UpdatesEntry
	nil,                               // 71: taskqueue.GetWorkerStatsResponse.WorkerStatsEntry
...
var file_taskqueue_proto_depIdxs = []int32{
	...
	70, // 2: taskqueue.TaskUpdateList.updates:type_name -> taskqueue.TaskUpdateList.UpdatesEntry
	...
	71, // 19: taskqueue.GetWorkerStatsResponse.worker_stats:type_name -> taskqueue.GetWorkerStatsResponse.WorkerStatsEntry
	8,  // 20: taskqueue.TaskUpdateList.UpdatesEntry.value:type_name -> taskqueue.TaskUpdate
	62, // 21: taskqueue.GetWorkerStatsResponse.WorkerStatsEntry.value:type_name -> taskqueue.WorkerStats
	2,  // 22: taskqueue.TaskQueue.SubmitTask:input_type -> taskqueue.TaskRequest
	1,  // 23: taskqueue.TaskQueue.RegisterWorker:input_type -> taskqueue.WorkerInfo
	24, // 24: taskqueue.TaskQueue.PingAndTakeNewTasks:input_type -> taskqueue.PingAndGetNewTasksRequest
	11, // 25: taskqueue.TaskQueue.UpdateTaskStatus:input_type -> taskqueue.TaskStatusUpdate
	12, // 26: taskqueue.TaskQueue.SendTaskLogs:input_type -> taskqueue.TaskLog
	17, // 27: taskqueue.TaskQueue.StreamTaskLogsOutput:input_type -> taskqueue.TaskId
	17, // 28: taskqueue.TaskQueue.StreamTaskLogsErr:input_type -> taskqueue.TaskId
	13, // 29: taskqueue.TaskQueue.GetLogsChunk:input_type -> taskqueue.GetLogsRequest
	26, // 30: taskqueue.TaskQueue.ListTasks:input_type -> taskqueue.ListTasksRequest
	7,  // 31: taskqueue.TaskQueue.ListWorkers:input_type -> taskqueue.ListWorkersRequest
	27, // 32: taskqueue.TaskQueue.CreateWorker:input_type -> taskqueue.WorkerRequest
	20, // 33: taskqueue.TaskQueue.UpdateWorkerStatus:input_type -> taskqueue.WorkerStatus
	18, // 34: taskqueue.TaskQueue.DeleteWorker:input_type -> taskqueue.WorkerId
	28, // 35: taskqueue.TaskQueue.UpdateWorker:input_type -> taskqueue.WorkerUpdateRequest
	19, // 36: taskqueue.TaskQueue.GetWorkerStatuses:input_type -> taskqueue.WorkerStatusRequest
	32, // 37: taskqueue.TaskQueue.ListJobs:input_type -> taskqueue.ListJobsRequest
	36, // 38: taskqueue.TaskQueue.GetJobStatuses:input_type -> taskqueue.JobStatusRequest
	34, // 39: taskqueue.TaskQueue.DeleteJob:input_type -> taskqueue.JobId
	29, // 40: taskqueue.TaskQueue.ListFlavors:input_type -> taskqueue.ListFlavorsRequest
	72, // 41: taskqueue.TaskQueue.GetRcloneConfig:input_type -> google.protobuf.Empty
	40, // 42: taskqueue.TaskQueue.Login:input_type -> taskqueue.LoginRequest
	42, // 43: taskqueue.TaskQueue.Logout:input_type -> taskqueue.Token
	43, // 44: taskqueue.TaskQueue.CreateUser:input_type -> taskqueue.CreateUserRequest
	72, // 45: taskqueue.TaskQueue.ListUsers:input_type -> google.protobuf.Empty
	44, // 46: taskqueue.TaskQueue.DeleteUser:input_type -> taskqueue.UserId
	45, // 47: taskqueue.TaskQueue.UpdateUser:input_type -> taskqueue.User
	47, // 48: taskqueue.TaskQueue.ChangePassword:input_type -> taskqueue.ChangePasswordRequest
	48, // 49: taskqueue.TaskQueue.ListRecruiters:input_type -> taskqueue.RecruiterFilter
	50, // 50: taskqueue.TaskQueue.CreateRecruiter:input_type -> taskqueue.Recruiter
	51, // 51: taskqueue.TaskQueue.UpdateRecruiter:input_type -> taskqueue.RecruiterUpdate
	49, // 52: taskqueue.TaskQueue.DeleteRecruiter:input_type -> taskqueue.RecruiterId
	53, // 53: taskqueue.TaskQueue.ListWorkflows:input_type -> taskqueue.WorkflowFilter
	56, // 54: taskqueue.TaskQueue.CreateWorkflow:input_type -> taskqueue.WorkflowRequest
	54, // 55: taskqueue.TaskQueue.DeleteWorkflow:input_type -> taskqueue.WorkflowId
	54, // 56: taskqueue.TaskQueue.ListSteps:input_type -> taskqueue.WorkflowId
	60, // 57: taskqueue.TaskQueue.CreateStep:input_type -> taskqueue.StepRequest
	58, // 58: taskqueue.TaskQueue.DeleteStep:input_type -> taskqueue.StepId
	66, // 59: taskqueue.TaskQueue.GetWorkerStats:input_type -> taskqueue.GetWorkerStatsRequest
	68, // 60: taskqueue.TaskQueue.FetchList:input_type -> taskqueue.FetchListRequest
	0,  // 61: taskqueue.TaskQueue.SubmitTask:output_type -> taskqueue.TaskResponse
	18, // 62: taskqueue.TaskQueue.RegisterWorker:output_type -> taskqueue.WorkerId
	10, // 63: taskqueue.TaskQueue.PingAndTakeNewTasks:output_type -> taskqueue.TaskListAndOther
	25, // 64: taskqueue.TaskQueue.UpdateTaskStatus:output_type -> taskqueue.Ack
	25, // 65: taskqueue.TaskQueue.SendTaskLogs:output_type -> taskqueue.Ack
	12, // 66: taskqueue.TaskQueue.StreamTaskLogsOutput:output_type -> taskqueue.TaskLog
	12, // 67: taskqueue.TaskQueue.StreamTaskLogsErr:output_type -> taskqueue.TaskLog
	15, // 68: taskqueue.TaskQueue.GetLogsChunk:output_type -> taskqueue.LogChunkList
	4,  // 69: taskqueue.TaskQueue.ListTasks:output_type -> taskqueue.TaskList
	6,  // 70: taskqueue.TaskQueue.ListWorkers:output_type -> taskqueue.WorkersList
	23, // 71: taskqueue.TaskQueue.CreateWorker:output_type -> taskqueue.WorkerIds
	25, // 72: taskqueue.TaskQueue.UpdateWorkerStatus:output_type -> taskqueue.Ack
	34, // 73: taskqueue.TaskQueue.DeleteWorker:output_type -> taskqueue.JobId
	25, // 74: taskqueue.TaskQueue.UpdateWorker:output_type -> taskqueue.Ack
	21, // 75: taskqueue.TaskQueue.GetWorkerStatuses:output_type -> taskqueue.WorkerStatusResponse
	35, // 76: taskqueue.TaskQueue.ListJobs:output_type -> taskqueue.JobsList
	38, // 77: taskqueue.TaskQueue.GetJobStatuses:output_type -> taskqueue.JobStatusResponse
	25, // 78: taskqueue.TaskQueue.DeleteJob:output_type -> taskqueue.Ack
	31, // 79: taskqueue.TaskQueue.ListFlavors:output_type -> taskqueue.FlavorsList
	39, // 80: taskqueue.TaskQueue.GetRcloneConfig:output_type -> taskqueue.RcloneConfig
	41, // 81: taskqueue.TaskQueue.Login:output_type -> taskqueue.LoginResponse
	25, // 82: taskqueue.TaskQueue.Logout:output_type -> taskqueue.Ack
	44, // 83: taskqueue.TaskQueue.CreateUser:output_type -> taskqueue.UserId
	46, // 84: taskqueue.TaskQueue.ListUsers:output_type -> taskqueue.UsersList
	25, // 85: taskqueue.TaskQueue.DeleteUser:output_type -> taskqueue.Ack
	25, // 86: taskqueue.TaskQueue.UpdateUser:output_type -> taskqueue.Ack
	25, // 87: taskqueue.TaskQueue.ChangePassword:output_type -> taskqueue.Ack
	52, // 88: taskqueue.TaskQueue.ListRecruiters:output_type -> taskqueue.RecruiterList
	25, // 89: taskqueue.TaskQueue.CreateRecruiter:output_type -> taskqueue.Ack
	25, // 90: taskqueue.TaskQueue.UpdateRecruiter:output_type -> taskqueue.Ack
	25, // 91: taskqueue.TaskQueue.DeleteRecruiter:output_type -> taskqueue.Ack
	57, // 92: taskqueue.TaskQueue.ListWorkflows:output_type -> taskqueue.WorkflowList
	54, // 93: taskqueue.TaskQueue.CreateWorkflow:output_type -> taskqueue.WorkflowId
	25, // 94: taskqueue.TaskQueue.DeleteWorkflow:output_type -> taskqueue.Ack
	61, // 95: taskqueue.TaskQueue.ListSteps:output_type -> taskqueue.StepList
	58, // 96: taskqueue.TaskQueue.CreateStep:output_type -> taskqueue.StepId
	25, // 97: taskqueue.TaskQueue.DeleteStep:output_type -> taskqueue.Ack
	67, // 98: taskqueue.TaskQueue.GetWorkerStats:output_type -> taskqueue.GetWorkerStatsResponse
	69, // 99: taskqueue.TaskQueue.FetchList:output_type -> taskqueue.FetchListResponse
