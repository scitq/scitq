...
const file_taskqueue_proto_rawDesc = "" +
	...
	"\bstatuses\x18\x01 \x03(\v2\x14.taskqueue.JobStatusR\bstatuses\"&\n" +
	...
	"\x04disk\x18\x04 \x01(\x02R\x04disk2\x94\x18\n" +
	"\tTaskQueue\x12=\n" +
	"\n" +
	...
	"\x16RegisterSpecifications\x12\x17.taskqueue.ResourceSpec\x1a\x0e.taskqueue.AckB\x11Z\x0fgen/taskqueuepbb\x06proto3"
...
var file_taskqueue_proto_msgTypes = make([]protoimpl.MessageInfo, 87)
var file_taskqueue_proto_goTypes = []any{
	...
	(*RcloneConfig)(nil),              // 39: taskqueue.RcloneConfig
	(*LoginRequest)(nil),              // 40: taskqueue.LoginRequest
	(*LoginResponse)(nil),             // 41: taskqueue.LoginResponse
	(*Token)(nil),                     // 42: taskqueue.Token
	(*CreateUserRequest)(nil),         // 43: taskqueue.CreateUserRequest
	(*UserId)(nil),                    // 44: taskqueue.UserId
	(*User)(nil),                      // 45: taskqueue.User
	(*UsersList)(nil),                 // 46: taskqueue.UsersList
	(*ChangePasswordRequest)(nil),     // 47: taskqueue.ChangePasswordRequest
	(*RecruiterFilter)(nil),           // 48: taskqueue.RecruiterFilter
	(*RecruiterId)(nil),               // 49: taskqueue.RecruiterId
	(*Recruiter)(nil),                 // 50: taskqueue.Recruiter
	(*RecruiterUpdate)(nil),           // 51: taskqueue.RecruiterUpdate
	(*RecruiterList)(nil),             // 52: taskqueue.RecruiterList
	(*WorkflowFilter)(nil),            // 53: taskqueue.WorkflowFilter
	(*WorkflowId)(nil),                // 54: taskqueue.WorkflowId
	(*Workflow)(nil),                  // 55: taskqueue.Workflow
	(*WorkflowRequest)(nil),           // 56: taskqueue.WorkflowRequest
	(*WorkflowList)(nil),              // 57: taskqueue.WorkflowList
	(*StepFilter)(nil),                // 58: taskqueue.StepFilter
	(*StepId)(nil),                    // 59: taskqueue.StepId
	(*Step)(nil),                      // 60: taskqueue.Step
	(*StepRequest)(nil),               // 61: taskqueue.StepRequest
	(*StepList)(nil),                  // 62: taskqueue.StepList
	(*WorkerStats)(nil),               // 63: taskqueue.WorkerStats
	(*DiskUsage)(nil),                 // 64: taskqueue.DiskUsage
	(*DiskIOStats)(nil),               // 65: taskqueue.DiskIOStats
	(*NetIOStats)(nil),                // 66: taskqueue.NetIOStats
	(*GetWorkerStatsRequest)(nil),     // 67: taskqueue.GetWorkerStatsRequest
	(*GetWorkerStatsResponse)(nil),    // 68: taskqueue.GetWorkerStatsResponse
	(*FetchListRequest)(nil),          // 69: taskqueue.FetchListRequest
	(*FetchListResponse)(nil),         // 70: taskqueue.FetchListResponse
	(*UploadTemplateRequest)(nil),     // 71: taskqueue.UploadTemplateRequest
	(*UploadTemplateResponse)(nil),    // 72: taskqueue.UploadTemplateResponse
	(*RunTemplateRequest)(nil),        // 73: taskqueue.RunTemplateRequest
	(*TemplateFilter)(nil),            // 74: taskqueue.TemplateFilter
	(*Template)(nil),                  // 75: taskqueue.Template
	(*TemplateList)(nil),              // 76: taskqueue.TemplateList
	(*TemplateRun)(nil),               // 77: taskqueue.TemplateRun
	(*TemplateRunList)(nil),           // 78: taskqueue.TemplateRunList
	(*TemplateRunFilter)(nil),         // 79: taskqueue.TemplateRunFilter
	(*UpdateTemplateRunRequest)(nil),  // 80: taskqueue.UpdateTemplateRunRequest
	(*WorkspaceRootRequest)(nil),      // 81: taskqueue.WorkspaceRootRequest
	(*WorkspaceRootResponse)(nil),     // 82: taskqueue.WorkspaceRootResponse
	(*DeleteTemplateRunRequest)(nil),  // 83: taskqueue.DeleteTemplateRunRequest
	(*ResourceSpec)(nil),              // 84: taskqueue.ResourceSpec
	nil,                               // 85: taskqueue.TaskUpdateList.UpdatesEntry
	nil,                               // 86: taskqueue.GetWorkerStatsResponse.WorkerStatsEntry
...
var file_taskqueue_proto_depIdxs = []int32{
	...
	85, // 2: taskqueue.TaskUpdateList.updates:type_name -> taskqueue.TaskUpdateList.UpdatesEntry
	...
	63, // 8: taskqueue.PingAndGetNewTasksRequest.stats:type_name -> taskqueue.WorkerStats
	...
	45, // 12: taskqueue.UsersList.users:type_name -> taskqueue.User
	50, // 13: taskqueue.RecruiterList.recruiters:type_name -> taskqueue.Recruiter
	55, // 14: taskqueue.WorkflowList.workflows:type_name -> taskqueue.Workflow
	60, // 15: taskqueue.StepList.steps:type_name -> taskqueue.Step
	64, // 16: taskqueue.WorkerStats.disks:type_name -> taskqueue.DiskUsage
	65, // 17: taskqueue.WorkerStats.disk_io:type_name -> taskqueue.DiskIOStats
	66, // 18: taskqueue.WorkerStats.net_io:type_name -> taskqueue.NetIOStats
	86, // 19: taskqueue.GetWorkerStatsResponse.worker_stats:type_name -> taskqueue.GetWorkerStatsResponse.WorkerStatsEntry
	75, // 20: taskqueue.TemplateList.templates:type_name -> taskqueue.Template
	77, // 21: taskqueue.TemplateRunList.runs:type_name -> taskqueue.TemplateRun
	8,  // 22: taskqueue.TaskUpdateList.UpdatesEntry.value:type_name -> taskqueue.TaskUpdate
	63, // 23: taskqueue.GetWorkerStatsResponse.WorkerStatsEntry.value:type_name -> taskqueue.WorkerStats
	2,  // 24: taskqueue.TaskQueue.SubmitTask:input_type -> taskqueue.TaskRequest
	1,  // 25: taskqueue.TaskQueue.RegisterWorker:input_type -> taskqueue.WorkerInfo
	24, // 26: taskqueue.TaskQueue.PingAndTakeNewTasks:input_type -> taskqueue.PingAndGetNewTasksRequest
	11, // 27: taskqueue.TaskQueue.UpdateTaskStatus:input_type -> taskqueue.TaskStatusUpdate
	12, // 28: taskqueue.TaskQueue.SendTaskLogs:input_type -> taskqueue.TaskLog
	17, // 29: taskqueue.TaskQueue.StreamTaskLogsOutput:input_type -> taskqueue.TaskId
	17, // 30: taskqueue.TaskQueue.StreamTaskLogsErr:input_type -> taskqueue.TaskId
	13, // 31: taskqueue.TaskQueue.GetLogsChunk:input_type -> taskqueue.GetLogsRequest
	26, // 32: taskqueue.TaskQueue.ListTasks:input_type -> taskqueue.ListTasksRequest
	7,  // 33: taskqueue.TaskQueue.ListWorkers:input_type -> taskqueue.ListWorkersRequest
	27, // 34: taskqueue.TaskQueue.CreateWorker:input_type -> taskqueue.WorkerRequest
	20, // 35: taskqueue.TaskQueue.UpdateWorkerStatus:input_type -> taskqueue.WorkerStatus
	18, // 36: taskqueue.TaskQueue.DeleteWorker:input_type -> taskqueue.WorkerId
	28, // 37: taskqueue.TaskQueue.UpdateWorker:input_type -> taskqueue.WorkerUpdateRequest
	19, // 38: taskqueue.TaskQueue.GetWorkerStatuses:input_type -> taskqueue.WorkerStatusRequest
	32, // 39: taskqueue.TaskQueue.ListJobs:input_type -> taskqueue.ListJobsRequest
	...
	87, // 43: taskqueue.TaskQueue.GetRcloneConfig:input_type -> google.protobuf.Empty
	...
	87, // 47: taskqueue.TaskQueue.ListUsers:input_type -> google.protobuf.Empty
	...
	48, // 51: taskqueue.TaskQueue.ListRecruiters:input_type -> taskqueue.RecruiterFilter
	50, // 52: taskqueue.TaskQueue.CreateRecruiter:input_type -> taskqueue.Recruiter
	51, // 53: taskqueue.TaskQueue.UpdateRecruiter:input_type -> taskqueue.RecruiterUpdate
	49, // 54: taskqueue.TaskQueue.DeleteRecruiter:input_type -> taskqueue.RecruiterId
	53, // 55: taskqueue.TaskQueue.ListWorkflows:input_type -> taskqueue.WorkflowFilter
	56, // 56: taskqueue.TaskQueue.CreateWorkflow:input_type -> taskqueue.WorkflowRequest
	54, // 57: taskqueue.TaskQueue.DeleteWorkflow:input_type -> taskqueue.WorkflowId
	58, // 58: taskqueue.TaskQueue.ListSteps:input_type -> taskqueue.StepFilter
	61, // 59: taskqueue.TaskQueue.CreateStep:input_type -> taskqueue.StepRequest
	59, // 60: taskqueue.TaskQueue.DeleteStep:input_type -> taskqueue.StepId
	67, // 61: taskqueue.TaskQueue.GetWorkerStats:input_type -> taskqueue.GetWorkerStatsRequest
	69, // 62: taskqueue.TaskQueue.FetchList:input_type -> taskqueue.FetchListRequest
	71, // 63: taskqueue.TaskQueue.UploadTemplate:input_type -> taskqueue.UploadTemplateRequest
	73, // 64: taskqueue.TaskQueue.RunTemplate:input_type -> taskqueue.RunTemplateRequest
	74, // 65: taskqueue.TaskQueue.ListTemplates:input_type -> taskqueue.TemplateFilter
	79, // 66: taskqueue.TaskQueue.ListTemplateRuns:input_type -> taskqueue.TemplateRunFilter
	80, // 67: taskqueue.TaskQueue.UpdateTemplateRun:input_type -> taskqueue.UpdateTemplateRunRequest
	83, // 68: taskqueue.TaskQueue.DeleteTemplateRun:input_type -> taskqueue.DeleteTemplateRunRequest
	81, // 69: taskqueue.TaskQueue.GetWorkspaceRoot:input_type -> taskqueue.WorkspaceRootRequest
	84, // 70: taskqueue.TaskQueue.RegisterSpecifications:input_type -> taskqueue.ResourceSpec
	0,  // 71: taskqueue.TaskQueue.SubmitTask:output_type -> taskqueue.TaskResponse
	18, // 72: taskqueue.TaskQueue.RegisterWorker:output_type -> taskqueue.WorkerId
	10, // 73: taskqueue.TaskQueue.PingAndTakeNewTasks:output_type -> taskqueue.TaskListAndOther
	25, // 74: taskqueue.TaskQueue.UpdateTaskStatus:output_type -> taskqueue.Ack
	25, // 75: taskqueue.TaskQueue.SendTaskLogs:output_type -> taskqueue.Ack
	12, // 76: taskqueue.TaskQueue.StreamTaskLogsOutput:output_type -> taskqueue.TaskLog
	12, // 77: taskqueue.TaskQueue.StreamTaskLogsErr:output_type -> taskqueue.TaskLog
	15, // 78: taskqueue.TaskQueue.GetLogsChunk:output_type -> taskqueue.LogChunkList
	4,  // 79: taskqueue.TaskQueue.ListTasks:output_type -> taskqueue.TaskList
	6,  // 80: taskqueue.TaskQueue.ListWorkers:output_type -> taskqueue.WorkersList
	23, // 81: taskqueue.TaskQueue.CreateWorker:output_type -> taskqueue.WorkerIds
	25, // 82: taskqueue.TaskQueue.UpdateWorkerStatus:output_type -> taskqueue.Ack
	34, // 83: taskqueue.TaskQueue.DeleteWorker:output_type -> taskqueue.JobId
	25, // 84: taskqueue.TaskQueue.UpdateWorker:output_type -> taskqueue.Ack
	21, // 85: taskqueue.TaskQueue.GetWorkerStatuses:output_type -> taskqueue.WorkerStatusResponse
	35, // 86: taskqueue.TaskQueue.ListJobs:output_type -> taskqueue.JobsList
	38, // 87: taskqueue.TaskQueue.GetJobStatuses:output_type -> taskqueue.JobStatusResponse
	25, // 88: taskqueue.TaskQueue.DeleteJob:output_type -> taskqueue.Ack
	31, // 89: taskqueue.TaskQueue.ListFlavors:output_type -> taskqueue.FlavorsList
	39, // 90: taskqueue.TaskQueue.GetRcloneConfig:output_type -> taskqueue.RcloneConfig
	41, // 91: taskqueue.TaskQueue.Login:output_type -> taskqueue.LoginResponse
	25, // 92: taskqueue.TaskQueue.Logout:output_type -> taskqueue.Ack
	44, // 93: taskqueue.TaskQueue.CreateUser:output_type -> taskqueue.UserId
	46, // 94: taskqueue.TaskQueue.ListUsers:output_type -> taskqueue.UsersList
	25, // 95: taskqueue.TaskQueue.DeleteUser:output_type -> taskqueue.Ack
	25, // 96: taskqueue.TaskQueue.UpdateUser:output_type -> taskqueue.Ack
	25, // 97: taskqueue.TaskQueue.ChangePassword:output_type -> taskqueue.Ack
	52, // 98: taskqueue.TaskQueue.ListRecruiters:output_type -> taskqueue.RecruiterList
	25, // 99: taskqueue.TaskQueue.CreateRecruiter:output_type -> taskqueue.Ack
	25, // 100: taskqueue.TaskQueue.UpdateRecruiter:output_type -> taskqueue.Ack
	25, // 101: taskqueue.TaskQueue.DeleteRecruiter:output_type -> taskqueue.Ack
	57, // 102: taskqueue.TaskQueue.ListWorkflows:output_type -> taskqueue.WorkflowList
	54, // 103: taskqueue.TaskQueue.CreateWorkflow:output_type -> taskqueue.WorkflowId
	25, // 104: taskqueue.TaskQueue.DeleteWorkflow:output_type -> taskqueue.Ack
	62, // 105: taskqueue.TaskQueue.ListSteps:output_type -> taskqueue.StepList
	59, // 106: taskqueue.TaskQueue.CreateStep:output_type -> taskqueue.StepId
	25, // 107: taskqueue.TaskQueue.DeleteStep:output_type -> taskqueue.Ack
	68, // 108: taskqueue.TaskQueue.GetWorkerStats:output_type -> taskqueue.GetWorkerStatsResponse
	70, // 109: taskqueue.TaskQueue.FetchList:output_type -> taskqueue.FetchListResponse
	72, // 110: taskqueue.TaskQueue.UploadTemplate:output_type -> taskqueue.UploadTemplateResponse
	77, // 111: taskqueue.TaskQueue.RunTemplate:output_type -> taskqueue.TemplateRun
	76, // 112: taskqueue.TaskQueue.ListTemplates:output_type -> taskqueue.TemplateList
	78, // 113: taskqueue.TaskQueue.ListTemplateRuns:output_type -> taskqueue.TemplateRunList
	25, // 114: taskqueue.TaskQueue.UpdateTemplateRun:output_type -> taskqueue.Ack
	25, // 115: taskqueue.TaskQueue.DeleteTemplateRun:output_type -> taskqueue.Ack
	82, // 116: taskqueue.TaskQueue.GetWorkspaceRoot:output_type -> taskqueue.WorkspaceRootResponse
	25, // 117: taskqueue.TaskQueue.RegisterSpecifications:output_type -> taskqueue.Ack
