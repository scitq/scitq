<script lang="ts">
   ...
   * On success, displays a success message and resets the form fields.
...
<div class="createForm-form-container">  
  ...
  {#if successMessage}
    <div class="createForm-success-message">
      {successMessage}
    </div>
  {/if}
  ...
  <div class="createForm-form-group">
    ...
    <input 
      id="create-username" 
      data-testid="username-createUser" 
      type="text" 
      bind:value={username} 
  ...
  <div class="createForm-form-group createForm-password-field">
    ...
    <div class="createForm-password-container">
      <input 
        data-testid="password-createUser" 
        id="create-password" 
  ...
  <div class="createForm-form-group createForm-inline-checkbox">
    ...
    <input 
      data-testid="isAdmin-createUser" 
      id="create-admin" 
      type="checkbox" 
